...
public class RecipeValidatorTest
{
    ...
    [InlineData("")]
    [InlineData("          ")]
    public void Error_Empty_Values_Ingredients(string ingredient)
    {
        var validator = new RecipeValidator();
    ...
    [InlineData("")]
    [InlineData("          ")]
    public void Error_Empty_Values_Instruction(string instruction)
    {
        var validator = new RecipeValidator();
    ...
    public void Error_Instruction_Too_Long()
    {
        ...
        var request = RequestRecipeJsonBuilder.Build();
        request.Instructions.First().Text = RequestStringGenerator.Paragraph(minCharacters: 2001);
